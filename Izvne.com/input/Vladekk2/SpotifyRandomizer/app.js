(function(exports) {
	...
	redirect_uri = 'http://izvne.com/SpotifyRandomizer/callback.html';
	client_id = 'd3aa62e7db6d450dad364738cbb24929';
	...
	exports.startApp = function() {
	    setStatus('');
	    var allText = localStorage.getItem('SpotifyRandomizer-allText');
        $('#alltext').val(allText);
		...
		$('#start').click(function () {
		    ...
		    localStorage.setItem('SpotifyRandomizer-allText',$('#alltext').val());
	        doLogin(function() {});
	    });
